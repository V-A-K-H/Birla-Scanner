  ...
  return (
    ...
    <div className="form-box login">
      <div className="choose">
        <h2 className="choose-opt white-bg" id="student">
          STUDENT
        </h2>
        <h2 className="choose-opt white-bg" id="admin">
          ADMIN
        </h2>
      </div>
      <form action="#">
        ...
        <fieldset className="input-box">
          ...
          <span className="icon">
            <i className="fa-solid fa-eye-slash fa-lg" id="show-pass"></i>
          </span>
          <span className="icon">
      ...
      <footer id="pass-reset">Forget Password?</footer>
    </div>
  );
};
