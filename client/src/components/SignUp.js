...
const SignUp = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (response.jwtToken) {
        ...
        console.log(error)
        window.confirm(`The following error has come ${error}`)
      }
  ...
  return (
      ...
      <div className="choose">
          <h2 className="choose-opt white-bg" id="student">STUDENT</h2>
          <h2 className="choose-opt white-bg" id="admin">ADMIN</h2>
      </div>
      <form action="#">
          <fieldset className="input-box">
              <legend>Email</legend>
              <input type="email" required/>
              <span className="icon"><i className="fa-solid fa-envelope fa-lg"></i></span>
          </fieldset>
          <fieldset className="input-box">
              <legend>Password</legend>
              <input type="password" id="password" required/>
              <span className="icon"><i className="fa-solid fa-eye-slash fa-lg" id="show-pass"></i></span>
              <span className="icon"><i className="fa-solid fa-lock fa-lg"></i></span>
          </fieldset>
      </form>
      <button className="submit">LogIn</button>
      <footer id="pass-reset">
          Forget Password?
      </footer>
  </div>
    )
